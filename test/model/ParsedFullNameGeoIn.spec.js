...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NamSorApiV2.ParsedFullNameGeoIn();
  });
  ...
  describe('ParsedFullNameGeoIn', function() {
    it('should create an instance of ParsedFullNameGeoIn', function() {
      // uncomment below and update the code to test ParsedFullNameGeoIn
      //var instance = new NamSorApiV2.ParsedFullNameGeoIn();
      //expect(instance).to.be.a(NamSorApiV2.ParsedFullNameGeoIn);
    });
    ...
    it('should have the property prefixOrTitle (base name: "prefixOrTitle")', function() {
      // uncomment below and update the code to test the property prefixOrTitle
      //var instance = new NamSorApiV2.ParsedFullNameGeoIn();
      //expect(instance).to.be();
    });
