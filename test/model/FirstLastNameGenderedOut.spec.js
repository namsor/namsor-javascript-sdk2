...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NamSorApiV2.FirstLastNameGenderedOut();
  });
  ...
  describe('FirstLastNameGenderedOut', function() {
    it('should create an instance of FirstLastNameGenderedOut', function() {
      // uncomment below and update the code to test FirstLastNameGenderedOut
      //var instance = new NamSorApiV2.FirstLastNameGenderedOut();
      //expect(instance).to.be.a(NamSorApiV2.FirstLastNameGenderedOut);
    });
