...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NamSorApiV2.RomanizedNameOut();
  });
  ...
  describe('RomanizedNameOut', function() {
    it('should create an instance of RomanizedNameOut', function() {
      // uncomment below and update the code to test RomanizedNameOut
      //var instance = new NamSorApiV2.RomanizedNameOut();
      //expect(instance).to.be.a(NamSorApiV2.RomanizedNameOut);
    });
    ...
    it('should have the property latinName (base name: "latinName")', function() {
    ...
    it('should have the property sourceScript (base name: "sourceScript")', function() {
      // uncomment below and update the code to test the property sourceScript
      //var instance = new NamSorApiV2.RomanizedNameOut();
      //expect(instance).to.be();
    });

    it('should have the property targetScript (base name: "targetScript")', function() {
      // uncomment below and update the code to test the property targetScript
      //var instance = new NamSorApiV2.RomanizedNameOut();
      //expect(instance).to.be();
    });
