...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NamSorApiV2.APIPlanOut();
  });
  ...
  describe('APIPlanOut', function() {
    it('should create an instance of APIPlanOut', function() {
      // uncomment below and update the code to test APIPlanOut
      //var instance = new NamSorApiV2.APIPlanOut();
      //expect(instance).to.be.a(NamSorApiV2.APIPlanOut);
    });
