...
(function(root, factory) {
   ...
   * @alias module:model/SourceMetricsOut
   * @class
   */
   ...
   * @param {module:model/SourceMetricsOut} obj Optional instance to populate.
   * @return {module:model/SourceMetricsOut} The populated <code>SourceMetricsOut</code> instance.
   */
