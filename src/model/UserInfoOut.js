...
(function(root, factory) {
   ...
   * @module model/UserInfoOut
   * @version 2.0.13
   */

  /**
   * Constructs a new <code>UserInfoOut</code>.
   * @alias module:model/UserInfoOut
   * @class
   */
   ...
   * @param {module:model/UserInfoOut} obj Optional instance to populate.
   * @return {module:model/UserInfoOut} The populated <code>UserInfoOut</code> instance.
   */
  ...
  /**
   * @member {Array.<module:model/UserInfoOut>} otherInfos
   */
