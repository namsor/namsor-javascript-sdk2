...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/InvoiceItemOut'], factory);
   ...
   * @module model/InvoiceOut
   * @version 2.0.13
   */

  /**
   * Constructs a new <code>InvoiceOut</code>.
   * @alias module:model/InvoiceOut
   * @class
   */
   ...
   * @param {module:model/InvoiceOut} obj Optional instance to populate.
   * @return {module:model/InvoiceOut} The populated <code>InvoiceOut</code> instance.
   */
  ...
  /**
   * @member {Array.<module:model/InvoiceItemOut>} items
   */
