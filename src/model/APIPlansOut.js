...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/APIPlanOut'], factory);
   ...
   * @module model/APIPlansOut
   * @version 2.0.13
   */

  /**
   * Constructs a new <code>APIPlansOut</code>.
   * @alias module:model/APIPlansOut
   * @class
   */
   ...
   * @param {module:model/APIPlansOut} obj Optional instance to populate.
   * @return {module:model/APIPlansOut} The populated <code>APIPlansOut</code> instance.
   */
  ...
  /**
   * @member {Array.<module:model/APIPlanOut>} plans
   */
