...
(function(root, factory) {
   ...
   * @module com.namsor.sdk2.invoke/com.namsor.sdk2.model/APIBillingPeriodUsageOut
   * @version 2.0.10
   */

  /**
   * Constructs a new <code>APIBillingPeriodUsageOut</code>.
   * @alias module:com.namsor.sdk2.invoke/com.namsor.sdk2.model/APIBillingPeriodUsageOut
   * @class
   */
   ...
   * @param {module:com.namsor.sdk2.invoke/com.namsor.sdk2.model/APIBillingPeriodUsageOut} obj Optional instance to populate.
   * @return {module:com.namsor.sdk2.invoke/com.namsor.sdk2.model/APIBillingPeriodUsageOut} The populated <code>APIBillingPeriodUsageOut</code> instance.
   */
