...
(function(root, factory) {
   ...
   * @module com.namsor.sdk2.invoke/com.namsor.sdk2.model/PersonalNameGeoOut
   * @version 2.0.11
   */

  /**
   * Constructs a new <code>PersonalNameGeoOut</code>.
   * @alias module:com.namsor.sdk2.invoke/com.namsor.sdk2.model/PersonalNameGeoOut
   * @class
   */
   ...
   * @param {module:com.namsor.sdk2.invoke/com.namsor.sdk2.model/PersonalNameGeoOut} obj Optional instance to populate.
   * @return {module:com.namsor.sdk2.invoke/com.namsor.sdk2.model/PersonalNameGeoOut} The populated <code>PersonalNameGeoOut</code> instance.
   */
