...
(function(root, factory) {
   ...
   * @module com.namsor.sdk2.invoke/com.namsor.sdk2.model/StripeCardOut
   * @version 2.0.10
   */

  /**
   * Constructs a new <code>StripeCardOut</code>.
   * @alias module:com.namsor.sdk2.invoke/com.namsor.sdk2.model/StripeCardOut
   * @class
   */
   ...
   * @param {module:com.namsor.sdk2.invoke/com.namsor.sdk2.model/StripeCardOut} obj Optional instance to populate.
   * @return {module:com.namsor.sdk2.invoke/com.namsor.sdk2.model/StripeCardOut} The populated <code>StripeCardOut</code> instance.
   */
