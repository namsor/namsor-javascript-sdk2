...
(function(root, factory) {
   ...
   * @module com.namsor.sdk2.invoke/com.namsor.sdk2.model/NameMatchCandidateOut
   * @version 2.0.10
   */

  /**
   * Constructs a new <code>NameMatchCandidateOut</code>.
   * @alias module:com.namsor.sdk2.invoke/com.namsor.sdk2.model/NameMatchCandidateOut
   * @class
   */
   ...
   * @param {module:com.namsor.sdk2.invoke/com.namsor.sdk2.model/NameMatchCandidateOut} obj Optional instance to populate.
   * @return {module:com.namsor.sdk2.invoke/com.namsor.sdk2.model/NameMatchCandidateOut} The populated <code>NameMatchCandidateOut</code> instance.
   */
