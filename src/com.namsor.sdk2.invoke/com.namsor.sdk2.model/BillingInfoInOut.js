...
(function(root, factory) {
   ...
   * @module com.namsor.sdk2.invoke/com.namsor.sdk2.model/BillingInfoInOut
   * @version 2.0.10
   */

  /**
   * Constructs a new <code>BillingInfoInOut</code>.
   * @alias module:com.namsor.sdk2.invoke/com.namsor.sdk2.model/BillingInfoInOut
   * @class
   */
   ...
   * @param {module:com.namsor.sdk2.invoke/com.namsor.sdk2.model/BillingInfoInOut} obj Optional instance to populate.
   * @return {module:com.namsor.sdk2.invoke/com.namsor.sdk2.model/BillingInfoInOut} The populated <code>BillingInfoInOut</code> instance.
   */
