...
(function(root, factory) {
   ...
   * @module com.namsor.sdk2.invoke/com.namsor.sdk2.model/APICounterV2Out
   * @version 2.0.10
   */

  /**
   * Constructs a new <code>APICounterV2Out</code>.
   * @alias module:com.namsor.sdk2.invoke/com.namsor.sdk2.model/APICounterV2Out
   * @class
   */
   ...
   * @param {module:com.namsor.sdk2.invoke/com.namsor.sdk2.model/APICounterV2Out} obj Optional instance to populate.
   * @return {module:com.namsor.sdk2.invoke/com.namsor.sdk2.model/APICounterV2Out} The populated <code>APICounterV2Out</code> instance.
   */
  ...
  /**
   * @member {module:com.namsor.sdk2.invoke/com.namsor.sdk2.model/APIKeyOut} apiKey
   */
